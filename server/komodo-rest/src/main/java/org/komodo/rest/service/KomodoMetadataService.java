...
import org.komodo.rest.relational.response.RestMetadataDataSourceJdbcCatalogSchemaInfo;
...
public class KomodoMetadataService extends KomodoService {
    ...
    public Response getVdbs(final @Context HttpHeaders headers,
        ...
        try {
            ...
            for (final TeiidVdb vdb : vdbs) {
                RestMetadataVdb entity = entityFactory.createMetadataVdb(vdb, uow, this.repo, uriInfo.getBaseUri());
                entities.add(entity);
    ...
    public Response getTranslators(final @Context HttpHeaders headers,
        ...
        try {
            ...
            for (TeiidTranslator translator : translators) {
                RestVdbTranslator entity = entityFactory.createMetadataTranslator(translator, uriInfo.getBaseUri(), uow, properties);
                entities.add(entity);
    ...
    public Response getConnections(final @Context HttpHeaders headers,
        ...
        try {
            ...
            KomodoProperties properties = new KomodoProperties();
            for (TeiidDataSource dataSource : dataSources) {
                RestConnection entity = entityFactory.createMetadataDataSource(dataSource, uriInfo.getBaseUri(), uow, properties);
                entities.add(entity);
    ...
    public Response getConnection( final @Context HttpHeaders headers,
        ...
        try {
            ...
            Connection dataSource = getMetadataInstance().getConnection(uow, connectionName);
            if (dataSource == null)
    ...
    public Response getConnectionDefaultTranslator( final @Context HttpHeaders headers,
        ...
        try {
            Teiid teiidNode = getMetadataInstance();
            CachedTeiid getMetadataInstance() = importContent(teiidNode);
    ...
    public Response copyConnectionsIntoRepo( final @Context HttpHeaders headers,
        ...
        try {
            ...
            Connection[] teiidConns = getMetadataInstance().getConnections(uow);
    ...
    public Response getDrivers(final @Context HttpHeaders headers,
        ...
        try {
            ...
            Driver[] drivers = getMetadataInstance().getDrivers(uow);
    ...
    public Response removeDriver(final @Context HttpHeaders headers,
        ...
        try {
            ...
            getMetadataInstance().undeployDriver(driverName);
            ...
            String title = RelationalMessages.getString(RelationalMessages.Info.DRIVER_DEPLOYMENT_STATUS_TITLE);
            KomodoStatusObject status = new KomodoStatusObject(title);
            if (! hasDriver(driverName, teiidNode)) {
    ...
    public Response getDataserviceDeployableStatus( final @Context HttpHeaders headers,
        ...
        try {
            ...
            Vdb serverVdb = getMetadataInstance().getVdb(uow, serviceVdbName);
    ...
    public Response addDataservice(final @Context HttpHeaders headers,
        ...
        try {
            ...
            try {
                // Make sure Dataservice constituents are current in the getMetadataInstance()
...
////    }
    ...
    public Response getConnectionJdbcTables( final @Context HttpHeaders headers,
        ...
        try {
            ...
            Connection dataSource = getMetadataInstance().getConnection(uow, attr.getDataSourceName());
            if (dataSource == null)
...
//
//            Template[] templates = getMetadataInstance().getTemplates(uow);
...
//            uow = createTransaction(principal, "getTemplates", true); //$NON-NLS-1$
//
//            Template template = getMetadataInstance().getTemplate(uow, templateName);
//            if (template == null)
